...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -fno-tree-vectorize -fgcse-las
...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mcpu=cortex-a15 -mfpu=neon-vfpv4
AFLAGS_KERNEL	=
